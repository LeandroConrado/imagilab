<x-filament-panels::page>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                {{ $this->getViewData()['completed_orders'] }}
                            </dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                {{ $this->getViewData()['pending_orders'] }}
                            </dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                R$ {{ number_format($this->getViewData()['total_revenue'], 2, ',', '.') }}
                            </dd>
                        </dl>
                    </div>
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg mb-6">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Tendência de Vendas</h3>
            <div class="h-64 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 rounded-lg flex items-center justify-center">
                <div class="text-center">
                    <x-heroicon-o-chart-bar class="w-16 h-16 text-gray-400 mx-auto mb-4"/>
                    <p class="text-gray-500 dark:text-gray-400">Gráfico de tendência de vendas</p>
                    <p class="text-sm text-gray-400 dark:text-gray-500">Integração com Chart.js em desenvolvimento</p>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- Filtros Aplicados --}}
    @if($date_from || $date_to || $customer_id || $status_filter)
    ...
    <div class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
        <p>Relatório de vendas gerado em {{ now()->format('d/m/Y H:i:s') }}</p>
        <p>Sistema Imagilab - Análise de Vendas e Performance</p>
    </div>
</x-filament-panels::page>